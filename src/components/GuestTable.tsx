            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2">
                  ...
                  {g.photo_opt_in === true && (
                    <Camera size={13} className="shrink-0 text-brand-light" />
                  )}
                </div>
              ...
              <div className="shrink-0 flex flex-col items-end gap-0.5">
                ...
                {g.trip_time && <span className="text-[10px] text-brand-light">{g.trip_time}</span>}
              </div>
            </button>
                ...
                <div className="grid grid-cols-2 gap-2">
                  {g.guest_email && (
                    <div className="col-span-2 flex items-center gap-2 text-sm text-zinc-300">
                      ...
                      {g.photo_opt_in === true && (
                        <span className="flex items-center gap-1 text-[10px] font-bold bg-brand-light/20 text-brand-light px-1.5 py-0.5 rounded-full shrink-0">
